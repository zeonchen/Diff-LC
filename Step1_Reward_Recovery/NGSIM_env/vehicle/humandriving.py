...
class NGSIMVehicle(IDMVehicle):
    ...
    @classmethod
    def create(cls, road, vehicle_ID, position, v_length, v_width, ngsim_traj, heading=0, velocity=15, acc_x=0, acc_y=0):
        """
        ...
        v = cls(road, position, heading, velocity, acc_x, acc_y, vehicle_ID=vehicle_ID, v_length=v_length, v_width=v_width, ngsim_traj=ngsim_traj)
...
class HumanLikeVehicle(IDMVehicle):
    ...
    @classmethod
    def create(cls, road, vehicle_ID, position, v_length, v_width, ngsim_traj, heading=0, velocity=0, acc_x=0, acc_y=0, target_velocity=15, human=False, IDM=False):
        """
        Create a human-like (IRL) driving vehicle in replace of a NGSIM vehicle.
        """
        v = cls(road, position, heading, velocity, acc_x, acc_y, target_velocity=target_velocity,
